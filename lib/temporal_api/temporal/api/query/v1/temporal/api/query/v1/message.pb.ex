defmodule Temporal.Api.Query.V1.WorkflowQuery do
  ...
  use Protobuf,
    full_name: "temporal.api.query.v1.WorkflowQuery",
    proto_source: "temporal/api/query/v1/message.proto",
...
defmodule Temporal.Api.Query.V1.WorkflowQueryResult do
  ...
  use Protobuf,
    full_name: "temporal.api.query.v1.WorkflowQueryResult",
    proto_source: "temporal/api/query/v1/message.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Temporal.Api.Query.V1.QueryRejected do
  ...
  use Protobuf,
    full_name: "temporal.api.query.v1.QueryRejected",
    proto_source: "temporal/api/query/v1/message.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

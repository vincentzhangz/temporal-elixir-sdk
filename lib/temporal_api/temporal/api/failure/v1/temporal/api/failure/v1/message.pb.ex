defmodule Temporal.Api.Failure.V1.ApplicationFailureInfo do
  ...
  use Protobuf,
    ...
    proto_source: "temporal/api/failure/v1/message.proto",
  ...
  field :category, 5, type: Temporal.Api.Enums.V1.ApplicationErrorCategory, enum: true
end
...
defmodule Temporal.Api.Failure.V1.NexusOperationFailureInfo do
  ...
  use Protobuf,
    full_name: "temporal.api.failure.v1.NexusOperationFailureInfo",
    proto_source: "temporal/api/failure/v1/message.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Temporal.Api.Failure.V1.NexusHandlerFailureInfo do
  ...
  use Protobuf,
    full_name: "temporal.api.failure.v1.NexusHandlerFailureInfo",
    proto_source: "temporal/api/failure/v1/message.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Temporal.Api.Failure.V1.MultiOperationExecutionAborted do
  ...
  use Protobuf,
    full_name: "temporal.api.failure.v1.MultiOperationExecutionAborted",
    proto_source: "temporal/api/failure/v1/message.proto",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
end

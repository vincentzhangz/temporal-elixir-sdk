defmodule Temporal.Api.Workflowservice.V1.WorkflowService.Service do
  ...
  def proto_source(), do: "temporal/api/workflowservice/v1/service.proto"
  ...
  rpc :CountWorkers,
      Temporal.Api.Workflowservice.V1.CountWorkersRequest,
      Temporal.Api.Workflowservice.V1.CountWorkersResponse
